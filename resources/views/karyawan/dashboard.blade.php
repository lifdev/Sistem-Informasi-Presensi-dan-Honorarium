                    ...
                    @if ($presensiHariIni)
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between border-b pb-3">
                                ...
                                <span class="font-semibold">
                                    ...
                                    {!! $presensiHariIni->jam_pulang ?? '<span class="text-amber-600">Belum Absen</span>' !!}
                        ...
                        @if (!$presensiHariIni->jam_pulang)
                            <a href="{{ route('karyawan.presensi.index') }}"
                                class="mt-6 flex w-full items-center justify-center rounded-xl bg-amber-500 px-4 py-3 font-medium text-white transition hover:bg-amber-600">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between border-b pb-3">
                                ...
                                <span class="font-semibold text-green-600">
                                    ...
                                    + Rp {{ number_format($honorariumTerakhir->tunjangan, 0, ',', '.') }}
