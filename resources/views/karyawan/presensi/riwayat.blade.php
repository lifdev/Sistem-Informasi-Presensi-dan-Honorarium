                ...
                <table class="w-full text-left">
                    <thead class="bg-slate-50 dark:bg-slate-800">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-sm font-semibold text-slate-600 dark:text-slate-300">Pulang</th>
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        @forelse($presensi as $p)
                            ...
                            <tr class="dark:hover:bg-slate-800/50">
                                ...
                                <td class="px-4 py-3">
                                    @if ($p->jam_pulang)
                                        <div class="flex items-center font-semibold text-blue-600 dark:text-blue-400">
                                            <svg class="mr-1 h-4 w-4" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round"
