    ...
    <div
        ...
        <div
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @if (request('show') === 'all')
                <a href="{{ route('pimpinan.honorarium.index', array_merge(request()->except(['show', 'page']), ['bulan' => $bulan, 'tahun' => $tahun])) }}"
                ...
                @else
                <a href="{{ route('pimpinan.honorarium.index', array_merge(request()->except(['show', 'page']), ['bulan' => $bulan, 'tahun' => $tahun, 'show' => 'all'])) }}"
                    class="rounded-xl bg-slate-600 px-4 py-2 text-sm font-medium text-white hover:bg-slate-700">
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full">
                ...
                @if ($honorarium->isNotEmpty())
                <tfoot class="border-t border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-800">
